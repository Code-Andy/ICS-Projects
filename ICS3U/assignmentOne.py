...
# Updated:     2020-12-18
# -----------------------------------------------------------------------------
# Procrastinated too much. However, I finished early and I think I showed everything.
# Also changed topics because the bully one was too complex and needed to much dialogue


# function that checks the users input with other predetermined values
def checkResponse(inputValue, correctValue, secondaryValue, incorrectValue):
    ...
    while inputValue != correctValue and inputValue != secondaryValue and inputValue != incorrectValue:
        inputValue = input(
            "Incorrect answer, please enter one of the given options ").lower()
        if inputValue.isdigit():
            inputValue = int(inputValue)
    clearScreen()
...
idList = {'Joe': 568711, 'Bob': 562721,
          'William': 568721, 'Tyler': 568712, 'Andy': 568712}
...
if dialogueOne == True:
    ...
    if dialogueTwo == True:
        ...
        print("But since you have a good credit score of",
              creditScore[studentName], "and you don't seem to be in this part of the school often, do you know anyone who could of done it?")
        ...
        print(otherStudent, "'s id", idList[otherStudent],
              studentName, "'s id", idList[studentName], '\n')
        ...
        print(
            "But since you helped me I'll add a few points to you number and fix the typo")
